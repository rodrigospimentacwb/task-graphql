package br.com.pimenta.tarefasGraphql.domains.commons.config;

import br.com.pimenta.tarefasGraphql.domains.commons.exception.CommonExceptionResolver;
import br.com.pimenta.tarefasGraphql.domains.commons.service.JwtService;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request,
        ...
        try {
            ...
            commonExceptionResolver.resolveToSingleError(ex, null);
        }
